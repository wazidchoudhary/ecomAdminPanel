                ...
                <div class="page-tools">
                        ...
                        <div class="breadcrumbs">
                            <div class="breadcrumbs__container">
                                <ol class="breadcrumbs__list">
                                    ...
                                    <li class="breadcrumbs__item disabled"><a class="breadcrumbs__link" href="products.php#"><span>E-commerce</span>
                        <svg class="icon-icon-keyboard-right breadcrumbs__arrow">
                          <use xlink:href="#icon-keyboard-right"></use>
                        </svg></a>
                                    </li>
                    ...
                    <div class="page-tools__right">
                        <div class="page-tools__right-row">
                            <div class="page-tools__right-item"><a class="button-icon" href="products.php#"><span class="button-icon__icon">
                        ...
                        <table class="table table--lines">
                            ...
                            <thead class="table__header text-center">
                                <tr class="table__header-row text-center">
                                    ...
                                    <th class="table__th-sort"><span class="align-middle">Sub-Category</span><span class="sort sort--down"></span>
                                    </th>
                        ...
                        <div class="row">
                            ...
                            <div class="table-wrapper__pagination col-auto">
                                <ol class="pagination">
                                    ...
                                    <li class="pagination__item active"><a class="pagination__link" href="products.php#">1</a>
                                    </li>
