            ...
            <div class="page-tools">
                        ...
                        <div class="breadcrumbs__container">
                            <ol class="breadcrumbs__list">
                                ...
                                <li class="breadcrumbs__item disabled"><a class="breadcrumbs__link"
                                        href="orders.php#"><span>E-commerce</span>
                                        <svg class="icon-icon-keyboard-right breadcrumbs__arrow">
                                            <use xlink:href="#icon-keyboard-right"></use>
                                        </svg></a>
                                </li>
                ...
                <div class="page-tools__right">
                    <div class="page-tools__right-row">
                        <div class="page-tools__right-item"><a class="button-icon" href="orders.php#"><span
                    ...
                    <table class="table table--lines">
                        ...
                        <thead class="table__header">
                            <tr class="table__header-row">
                                ...
                                <th class="table__th-sort"><span class="align-middle">Customer Name</span><span
                                ...
                                <th class="table__th-sort"><span class="align-middle">Total</span><span
                                        class="sort sort--down"></span>
                                </th>
